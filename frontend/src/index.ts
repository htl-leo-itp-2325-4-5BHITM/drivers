...
function checkData(){
    ...
    if (!driverInput.trim() || driverInput.length <= 2) {
        ...
        (document.getElementById('errorWrongInputNewRide') as HTMLElement).innerHTML = 'Please enter a valid driver name.';
        isValid = false;
    }
    ...
    if (!departureInput.trim() || departureInput.length <= 2) {
        ...
        (document.getElementById('errorWrongInputNewRide') as HTMLElement).innerHTML = 'Please enter a valid departure location.';
        isValid = false;
    }
    ...
    if (!arrivalInput.trim() || arrivalInput.length <= 2) {
        ...
        (document.getElementById('errorWrongInputNewRide') as HTMLElement).innerHTML = 'Please enter a valid arrival location.';
        isValid = false;
    }
